...
from Mikey.modules.helper_funcs.chat_status import is_user_admin
from Mikey.modules.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Mikey.modules." + module_name)
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        ...
                        [
                            InlineKeyboardButton(
                                text="⚒ Support Group",
                                url=f"https://t.me/Mikey_Support",
                            ),
                            InlineKeyboardButton(
                                text="🔔 Updates",
                                url="https://t.me/MikeyUpdates",
                            ),
                        ],
                        [
                            InlineKeyboardButton(
                                text="📌 Tokyo Revengers",
                                url="https://t.me/Tokyo_Revengers_Dual",
                            ),
                            InlineKeyboardButton(
                                text="💬 Anime Chat",
